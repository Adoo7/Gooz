...
class Upload {
    ...
    function __construct() {
        $this->upload_dir = '';
        $this->max_file_size = 3048576; //Max File Size in Bytes, 1MB
        $this->allowed_mime_types = array('video/mp4', 'image/jpeg', 'image/png', 'image/gif', 'image/tiff', 'video/mpeg', 'video/x-msvideo', 'video/ogg', 'video/mp2t', 'video/webm', 'video/3gpp', 'video/3gpp2');
